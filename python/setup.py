...
if platform == "win32":
    ...
    folders = ['QuantLib','QuantExt','quantlibparser','nlohmann_json_schema_validator', 'nlohmann_json', 'pybind11', 'pybind11_json']
    ...
    libraries  = ['QuantLib-x64-mt','QuantExt-x64-mt','quantlibparser','nlohmann_json_schema_validator']
    ...
    libraries  = ['QuantLib','QuantExt','QuantLibParser','nlohmann_json_schema_validator']
    ...
    libraries  = ['QuantLib','QuantExt','QuantLibParser','nlohmann_json_schema_validator']
    extra_compile_args = ['-std=c++20','-arch','arm64','-arch','x86_64']
